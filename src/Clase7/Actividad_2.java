...
public class Actividad_2 {
    ...
    // Constructor
    public Actividad_2(int numeroCentros) {
    ...
    public void optimizarRutas() {
        ...
        // Imprimir la matriz final de tiempos mínimos de entrega
        imprimirSolucion();
    }

    // Mostrar la matriz de tiempos mínimos de entrega
    private void imprimirSolucion() {
        System.out.println("Matriz de tiempos mínimos de entrega entre todos los centros:");
        for (int i = 0; i < numeroCentros; i++) {
            for (int j = 0; j < numeroCentros; j++) {
                if (tiemposViaje[i][j] == INF) {
                    System.out.print("INF ");
                } else {
                    System.out.print(tiemposViaje[i][j] + "   ");
                }
            }
            System.out.println();
        }
    ...
    public static void main(String[] args) {
        ...
        Actividad_2 floydWarshall = new Actividad_2(4);
        ...
        // Mostrar el camino más corto entre centros de distribución
        floydWarshall.mostrarCamino(1, 4);
    }
}
