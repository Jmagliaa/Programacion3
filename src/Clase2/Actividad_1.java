package Clase2;
    ...
    public class Actividad_1 {
        ...
        private static int altura(TreeNode root) {
            if(root == null) { 
                return - 1; // vuelve al valor correcto
            } 
            else{
                return 1 + Math.max(altura(root.left), altura(root.right)); // recurrsion a los hijos posibles
            }    
        }
        ...
        public static void main(String[] args) {
            ...
            System.out.println("La altura del arbol es " + altura(root)); // debería imprimir 3
        }
}
